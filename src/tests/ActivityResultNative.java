...
public class ActivityResultNative extends Activity {
	...
	protected void onCreate(Bundle arg0) {
		...
		if (Intent.ACTION_BUG_REPORT.equalsIgnoreCase(getIntent().getAction())) {
			...
			findViewById(android.R.id.title).setOnClickListener(new OnClickListener() {
				@Override
				public void onClick(View v) {
					Intent intent = new Intent(ActivityResultNative.this, ActivityResultNative.class);
